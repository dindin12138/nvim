...
local M = {
    ...
    },
    {
        ...
        event = { 'BufReadPost', 'BufNewFile' },
        dependencies = { 'famiu/bufdelete.nvim', cmd = 'Bdelete' },
        config = ui_config.bufferline,
    },
    {
    ...
    { 'dstein64/vim-startuptime', cmd = 'StartupTime' },
    {
        ...
        event = { 'BufReadPost', 'BufNewFile' },
        config = tools_config.gitsigns
    },
    {
        'folke/which-key.nvim',
        config = tools_config.which_key
    },
    {
    ...
    { 'ray-x/lsp_signature.nvim', event = "InsertEnter", config = completion_config.lsp_signature },
    {
        ...
        cmd = 'AerialToggle',
        config = completion_config.aerial
    }
}
return M
